...
**Q3. Which model performed best for FUEL_TYPE and for CROWN_CLOS? Briefly justify your choice. Include one raster map for each. (5 points)**
...
**Q1. How many fuel types are in the VRI dataset? Which fuel type has the fewest points? (5 points)**

**Q2. What are the results of the spatial autocorrelation (SA) analysis? What do they indicate? Why was SA tested for CROWN_CLOS but not for FUEL_TYPE? (7 points)**

**Q3. Create a summary table of the Exploratory Regression diagnostics (R², AIC, VIF, significance) for the three best models. Which model had the highest R² and which variables were selected for the final model? (8 points)**
...
**Q4. Which model performed best for FUEL_TYPE and for CROWN_CLOS? Briefly justify your choice. Include one raster map for each. (8 points)**

**Q5. How did model performance differ among the three sampling strategies for fuel type? What are the main advantages and limitations of each? (6 points)**

**Q6. How did Random Forest parameter changes affect crown closure model performance? Which parameters should be optimized and why? (6 points)**

**Q7. Why were the selected variables effective for predicting crown closure? What other variables might better predict fuel type? (5 points)**

**Q8. What are the strengths and limitations of using remote sensing, climate, and terrain data for predicting fuel types and crown closure? (5 points)**
