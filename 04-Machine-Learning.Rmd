...
<input type="checkbox" unchecked> Summary table of the Exploratory Regression diagnostics (R², AIC, VIF, significance) for the three best models (5 points)</input>

<input type="checkbox" unchecked> Map of your prediction for FUEL_TYPE and CROWN_CLOS (20 points)</input>
...
##### Q4. Which model performed best for FUEL_TYPE and for CROWN_CLOS? Briefly justify your choice. (4 points) {.unnumbered}

##### Q5. How did model performance differ among the three sampling strategies for fuel type? What are the main advantages and limitations of each? (3 points) {.unnumbered}

##### Q6. How did Random Forest parameter changes affect crown closure model performance? Which parameters should be optimized and why? (3 points) {.unnumbered}

##### Q7. Why were the selected variables effective for predicting crown closure? What other variables might better predict fuel type? (3 points) {.unnumbered}

##### Q8. What are the strengths and limitations of using remote sensing, climate, and terrain data for predicting fuel types and crown closure? (2 points) {.unnumbered}

##### Map 1. Upload a map of your prediction for FUEL_TYPE and CROWN_CLOS (20 points) {.unnumbered}
