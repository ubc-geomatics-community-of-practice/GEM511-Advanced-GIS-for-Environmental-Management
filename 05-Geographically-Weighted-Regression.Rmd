...
<input type="checkbox" unchecked> Responses to the questions posed throughout the lab activities (25 points)
...
<input type="checkbox" unchecked> Maps showing the standardized residuals and local $R^2$ for each of the three NDVI statistics (10 points)

<input type="checkbox" unchecked> A short discussion addressing conclusions about green equity in Vancouver and recommendations for Vancouver City Council (5 points)
...
**Q1. Describe the main characteristics of the census dataset and the Landsat imagery used to derive the NDVI statistics**
...
**Q2. How did you evaluate the regression models and select your final model? Add a brief text describing the statistics that guided your decision**
...
**Q3. Why did you select the 10 explanatory variables used in Task 3?**

**Q4. Compare and contrast the different NDVI statistics used in this analysis. Which NDVI statistic produced the best-performing model and what evidence supports your conclusion?**

**Q5. Using the coefficient and standard error maps, interpret the spatial relationship between one independent variable and one NDVI statistic. What spatial patterns do you observe and what factors might explain them?**

**Q6.  What can you conclude about green equity among dissemnination areas in Vancouver?**

**Q7.  What are your final recommendations to city council about green equity in Vancouver?**
