...
<input type="checkbox" unchecked> A table comparing the Ordinary Least Squares (OLS) and Geographically Weighted Regression (GWR) models using the best subset of explanatory variables (10 points)

<input type="checkbox" unchecked> A map showing the standardized residuals and local $R^2$ for each of the three NDVI statistics (15 points)
...
-   `alt_geo_code = 59010100` represents the 100th `0100` **Dissemination Area (DA)** in the first CD
...
##### Q1. Describe the main characteristics of the census dataset and the Landsat imagery used to derive the NDVI statistics. (2 points) {-}
...
##### Q2. How did you evaluate the regression models and select your final model? Describe the statistics that guided your decision. (3 points) {-}
...
**Step 1:** Select 10 different census characteristics other than the 14 we worked with and repeat Steps 8 and 9 of Task 1. You will be expected to rationalize why you selected these 10 characteristics in your deliverables.
...
**Step 4:** Using your selected subset of independent variables, run the "Geographically Weighted Regression (GWR)" tool for each of the three dependent variables, NDVI statistics that you chose in Step 2. Record the output message and refer to these statistics when you compare your GWR results to your OLS results. Note if you receive an error message about multicollinearity, try reducing your independent variables or selecting other independent variables from the Statistics Canada dataset until you find a set that you can proceed with.

**Step 5:** Explore your GWR results and make maps of the following for each of the three different NDVI statistics that you will reference in your deliverables:
- Standardized residuals
- Local $R^2$

**Step 6:** Explore your GWR results and make a map of one "Coefficient" and one "Std.Error" for one of your independent variables. Reference these maps when you are explaining your results in your deliverables.

**Step 7:** Answer the following and previous questions in Canvas. Include the maps, tables, and figures generated in the previous steps.

##### Q3. Why did you select the 10 explanatory variables used in Task 3? (2 points) {-}

##### Q4. Compare and contrast the different NDVI statistics used in this analysis. Which NDVI statistic produced the best-performing model and what evidence supports your conclusion? (3 points) {-}

##### Q5. Using the coefficient and standard error maps, interpret the spatial relationship between one independent variable and one NDVI statistic. What spatial patterns do you observe and what factors might explain them? (5 points) {-}

##### Q6. What can you conclude about green equity among dissemnination areas in Vancouver? (5 points) {-}

##### Q7. What are your final recommendations to city council about green equity in Vancouver? (5 points) {-}
