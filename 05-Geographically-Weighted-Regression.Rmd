...
**Step 1:** Connect to the `greenequity` database on the UBC PostgreSQL server. Add two Landsat raster images: **LC08_L1TP_047026_20200814_20210330_02_T1_B4** and **LC08_L1TP_047026_20200814_20210330_02_T1_B5**. These images represent bands 4 (red) and 5 (near-infrared), respectively, and were acquired on August 14, 2020, which is approximately when the 2021 census data were collected.

**Step 2:** Open the "Raster Calculator" tool and calculate the Normalized Difference Vegetation Index (NDVI) and save the output in your project geodatabase simply as "ndvi":
...
```{r 05-arcgis-exploratory-regression-results, out.width= "75%", echo = FALSE}
...
```{r 05-arcgis-ols, out.width= "75%", echo = FALSE}
...
```{r 05-arcgis-variable-chart, out.width= "75%", echo = FALSE}
...
**Step 1:** Select 10 different census characteristics than the 14 we worked with and repeat Steps 8 and 9 of Task 1. You will be expected to rationalize why you selected these 10 characteristics in your report.
