...
##### Q1. What is the measured range of elevation by LiDAR within the AOI? (1 point)
...
##### Q2. What differences do you observe between the thinned and non-thinned datasets in terms of number of points, average point spacing, and the measured range of elevation? (3 points)
...
##### Q3. How might changing the parameters of this tool ("Interpolation Type", "Cell Assignment", and "Sampling Value") affect the statistical qualities of the output DEM? (6 points)
...
##### Q4. Summarize and describe how the interpolation methods differ from the binned DEM across elevation and slope classes. Which zones/methods are most similar or dissimilar? (10 points)

##### Table that shows zonal statistics of the difference rasters across elevation and slope ranges of the binned DEM (10 points)
...
##### A panel of maps that symbolizes the DEMs produced and the difference rasters that were produced by the comparison to the binning approach (15 points)
...
##### Q5. Which spatial interpolation algorithm would you recommend the research forest use? Defend and justify your choice. (5 points)
