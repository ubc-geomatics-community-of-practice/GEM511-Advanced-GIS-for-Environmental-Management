...
<input type="checkbox" unchecked> Responses to the questions posed throughout the lab on the course management system (25 points)</input>

<input type="checkbox" unchecked> Map panel (PDF or image) (15 points) 
Submit a panel of maps for **one conservation unit only**, including:</input>
...
<input type="checkbox" unchecked> Summary table (PDF, image, or text) (10 points)</input>
...
```{r 02-vancouver_island_flow_direction, out.width= "100%", echo = FALSE}
...
```{r 02-vancouver_island_flow_accumulation, out.width= "100%", echo = FALSE}
...
```{r 02-vancouver_island_con, out.width= "100%", echo = FALSE}
...
```{r 02-vancouver_island_stream_routes, out.width= "100%", echo = FALSE}
...
```{r 02-topology-errors, out.width= "50%", echo = FALSE}
...
```{r 02-vancouver_island_nibble, out.width= "75%", echo = FALSE}
...
```{r 02-create-trace-network, out.width= "75%", echo = FALSE}
