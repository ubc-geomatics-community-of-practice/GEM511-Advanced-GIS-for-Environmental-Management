...
**Step 2:** In ArcGIS Pro, add the Vancouver Island DEM to your map project. Clip the DEM to the "salmon.public.vancouver_island_boundary" using the clip raster tool, toggle on "use input features for clipping geometry".  
...
**Step 3:** Right-click on the feature dataset, select "Import", and then navigate to the **dams** layer on the UBC PostgreSQL server and import this layer into your feature dataset.
